						...
						<div class="layui-form-item">
							...
							<div class="layui-inline">
								<button type="button"
									...
									<i class="layui-icon layui-icon-add-1"></i>评价
								</button>
							</div>
		...
		<div class="layuimini-main">
			<form class="layui-form" action="" lay-filter="aexample">
            	...
            	<div class="layui-form-item">
	                ...
	                <div class="layui-input-block">
	                    <input type="text" name="content" autocomplete="off" lay-verify="required" lay-reqtext="必填项，不能为空" autocomplete="off" placeholder="请输入"
										class="layui-input">
	                </div>
            	</div> 
				<div class="layui-form-item">
	 ...
	 layui.use(['form', 'table','laydate','upload','rate'], function () {
            ...
            cols: [[
				...
				{width: 100, templet:'#no',title: 'NO', sort: true},
				 ...
				 {field: 'content', width: 250, title: '评价内容'},
                {field: 'optime', width: 250, title: '评价时间'},
              ...
              //表单初始赋值
               ...
               setFormValue(obj,data);    
                ...
                layer.confirm('真的删除行么', function (index) {
                    ...
                    $.getJSON('<%=Const.ROOT%>pingjia/delete',{'id':obj.data.id},function(msg) {
  						//console.log(msg);
  						if(msg.code=="0"){
        ...
        form.on('submit(add)', function (data) {
                //console.log(obj.data);
                $.getJSON('<%=Const.ROOT%>pingjia/add',data.field,function(msg) {
						//console.log(msg);
						if(msg.code=="0"){
							layer.msg(msg.msg, { icon: 6, time: 800},function(){
								location.reload();
