        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item layuimini-setting">
                ...
                <dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-iframe-tab="<%=Const.ROOT %>update_users.jsp" data-title="基本资料" data-icon="fa fa-gears">基本资料</a>
                    </dd>
                    <dd>
                        <a href="javascript:;" data-iframe-tab="<%=Const.ROOT %>password.jsp" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                    </dd>
                    <dd>
