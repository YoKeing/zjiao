                ...
                <div class="layui-row layui-col-space15">
                    <div class="layui-col-md12">
                        <div class="layui-card">
                            <div class="layui-card-header">欢迎使用教务管理系统系统</div>
    ...
    layui.use(['layer', 'layuimini','echarts'], function () {
        ...
        $('body').on('click', '.layuimini-notice', function () {
            var title = $(this).children('.layuimini-notice-title').text(),
                ...
                address = $(this).children('.layuimini-notice-address').text(),
                pid = $(this).children('.layuimini-notice-pid').text(),
            ...
            var html = '<div style="width:700px;height:400px;padding:15px 20px; text-align:justify; line-height: 22px;border-bottom:1px solid #e2e2e2;background-color: #2f4056;color: #ffffff">\n' +
                ...
                '<div style="margin-bottom: 20px;font-weight: bold;text-align:center;border-bottom:1px solid #718fb5;padding-bottom: 5px"><h5 class="text-danger" style="font-size:14px">培训师：' + pid + ' 地址：'+ address +'</h5></div>\n' +
                '<div style="font-size:18px;width:600px; word-wrap: break-word;word-break: break-all;overflow: auto;">' + content + '</div>\n' +
                '</div>\n';
            parent.layer.open({
                type: 1,
                title: '最新通知'+'<span style="float: right;right: 1px;font-size: 12px;color: #b1b3b9;margin-top: 1px">'+noticeTime+'</span>',
                area: '750px',
                shade: 0.8,
                id: 'layuimini-notice',
                btn: ['关闭'],
