...
<head>
    ...
    <style>
        ...
        .login-form {border:1px solid #fff;border-radius:3px;padding:14px 20px;box-shadow:0 0 8px #eeeeee;}
        ...
        <div class="layui-form login-form">
            <form class="layui-form">
                ...
                <div class="ayui-row layui-form-item">
                    ...
                    <button class="layui-btn layui-btn-fluid layui-btn-warm"  type="button" id="reg">注 册</button>
                    </div>  -->
                </div>
            </form>
        </div>
