			...
			<form class="layui-form" action="" lay-filter="uexample">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="number" min="0" name="score" lay-verify="required"
	 ...
	 layui.use(['form', 'table','laydate','upload','rate'], function () {
	      ...
	      //显示文字
            ...
            cols: [[
                ...
                {field: 'optime', width: 250, title: '选课时间'},
                {field: 'score', width: 120, title: '得分'},
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'shenhe') {
            	layer.confirm('是否审核通过？', function (index) {
                    ...
                    $.getJSON('<%=Const.ROOT%>xuanke/update',{'id':obj.data.id,'status':'已审核'},function(msg) {
  						//console.log(msg);
  						if(msg.code=="0"){
              ...
              //表单初始赋值
               ...
               setFormValue(obj,data);    
                ...
                layer.confirm('真的删除行么', function (index) {
                    //console.log(obj.data);
                    $.getJSON('<%=Const.ROOT%>xuanke/delete',{'id':obj.data.id},function(msg) {
  						//console.log(msg);
  						if(msg.code=="0"){
